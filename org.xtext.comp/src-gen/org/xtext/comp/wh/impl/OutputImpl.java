 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.wh.impl.OutputImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends MinimalEObjectImpl.Container implements Output
{
  ...
  public EList<String> getVars()
  {
    if (vars == null)
    {
      vars = new EDataTypeEList<String>(String.class, this, WhPackage.OUTPUT__VARS);
    }
    return vars;
  }
