...
public class CommandAffect implements CommandInstr,Affect {

	EList<Expr> expressions;
	EList<String> variables;
		public CommandAffect(Command c){
		this.expressions = ((Affect)c).getExprs();
		this.variables = ((Affect)c).getVars();
	}
	@Override
