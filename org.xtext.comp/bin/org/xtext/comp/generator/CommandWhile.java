...
public class CommandWhile implements CommandInstr,While{

	Commands commands;
	Expr expression;
	
	public CommandWhile(Command c){
		this.commands = ((While)c).getCmds();
		this.expression = ((While)c).getExpr();
	}
	...
	@Override
	public void setCmds(Commands value) {
		// TODO Auto-generated method stub
